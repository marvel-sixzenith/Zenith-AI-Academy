      ...
      <section className="pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        ...
        <div className="container max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4 animate-fade-in-up delay-200">
            <Link href="/register" className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto flex items-center justify-center gap-2 hover:scale-105 transition-transform animate-glow">
          ...
          <AnimatedSection animation="fade-in-scale">
            <div className="glass-card p-8 sm:p-12 text-center border-[var(--primary)]/30 relative overflow-hidden hover-glow">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                <Link href="/register" className="btn-primary text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 shadow-xl shadow-blue-500/20 hover:shadow-blue-500/40 transition-all flex items-center gap-3 w-full sm:w-auto justify-center animate-glow">
                  Daftar Sekarang
