...
import { Rocket, Wrench, Briefcase, ChevronRight, Zap, Users, Trophy, CheckCircle, HelpCircle, Star, ArrowRight, User } from 'lucide-react';

export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 glass-card border-x-0 border-t-0 rounded-none bg-[var(--background)]/80 backdrop-blur-md">
        <div className="container flex items-center justify-between h-16 px-4">
          <Link href="/" className="flex items-center gap-2 text-lg md:text-xl font-bold group">
            <Zap className="w-5 h-5 md:w-6 md:h-6 text-[var(--primary)] group-hover:text-[var(--primary-light)] transition-colors" />
            <span className="text-gradient">Zenith AI Academy</span>
          </Link>
          <nav className="hidden lg:flex items-center gap-6">
            <Link href="#tracks" className="text-[var(--text-secondary)] hover:text-white transition text-sm font-medium">
              Program
            </Link>
            <Link href="#features" className="text-[var(--text-secondary)] hover:text-white transition text-sm font-medium">
              Fitur
            </Link>
            <Link href="#curriculum" className="text-[var(--text-secondary)] hover:text-white transition text-sm font-medium">
              Kurikulum
            </Link>
            <Link href="#faq" className="text-[var(--text-secondary)] hover:text-white transition text-sm font-medium">
              FAQ
            </Link>
          </nav>
          <div className="flex items-center gap-3">
            ...
            <Link href="/register" className="btn-primary text-xs sm:text-sm py-2 px-4 sm:px-5 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 transition-all">
              Daftar Gratis
            </Link>
          </div>
        </div>
      ...
      <section className="pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] sm:w-[800px] h-[400px] sm:h-[500px] bg-blue-600/20 rounded-full blur-[120px] -z-10" />

        <div className="container max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-[var(--primary)]/10 border border-[var(--primary)]/20 mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[var(--text-secondary)] max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4">
            <Link href="/register" className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto flex items-center justify-center gap-2 hover:scale-105 transition-transform">
              Mulai Belajar Gratis
              <ChevronRight className="w-5 h-5" />
            </Link>
            <Link href="#tracks" className="btn-secondary text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto hover:bg-white/5 transition-colors">
              Lihat Program
            </Link>
          </div>

          <div className="mt-12 sm:mt-16 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-[var(--text-muted)] text-xs sm:text-sm font-medium px-4">
        ...
        <div className="container px-4 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="glass-card p-6 sm:p-10 border-[var(--primary)]/30">
      ...
      <section id="tracks" className="py-16 sm:py-24 relative">
        ...
        <div className="container px-4 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-start mb-8">
            {/* Engineer Track */}
            <div className="glass-card p-6 sm:p-8 group cursor-pointer hover:border-blue-500/50 transition-all duration-300 relative">
              ...
              <Link href="/register" className="btn-secondary w-full py-2.5 sm:py-3 text-center text-sm sm:text-base group-hover:bg-blue-500 group-hover:border-blue-500 transition-all">
                Mulai Sekarang
              </Link>
            </div>

            {/* Entrepreneur Track */}
            <div className="glass-card p-6 sm:p-8 group cursor-pointer hover:border-emerald-500/50 transition-all duration-300 relative">
              ...
              <Link href="/register" className="btn-secondary w-full py-2.5 sm:py-3 text-center text-sm sm:text-base group-hover:bg-emerald-500 group-hover:border-emerald-500 transition-all">
                Mulai Sekarang
              </Link>
            </div>
          </div>
          ...
          <div className="glass-card p-6 sm:p-8 border-amber-500/30 bg-amber-500/5 relative overflow-hidden mx-auto max-w-3xl">
            <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/30 text-amber-400 text-xs font-bold uppercase tracking-wider">
              Bonus Materi
            </div>

            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-amber-500/10 flex items-center justify-center mb-6 sm:mb-8">
              <Rocket className="w-7 h-7 sm:w-8 sm:h-8 text-amber-500" />
            </div>
            ...
            <Link href="/register" className="btn-secondary w-full py-2.5 sm:py-3 text-center text-sm sm:text-base border-amber-500/30 text-amber-400 hover:bg-amber-500/10">
              Akses Sekarang
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="lg:w-1/2">
              <div className="sticky top-24">
                <div className="glass-card p-1 bg-gradient-to-b from-[var(--primary)]/20 to-transparent">
                  <div className="bg-[#0a0a0f] rounded-xl overflow-hidden aspect-video relative group">
                    <div className="absolute inset-0 flex items-center justify-center bg-black/50 group-hover:bg-black/30 transition-all cursor-pointer">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20 group-hover:scale-110 transition-transform">
      ...
      <section id="features" className="py-16 sm:py-24">
        <div className="container px-4 max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="glass-card p-6 sm:p-8 text-center hover:bg-[var(--background-secondary)] transition-colors">
            ...
            <div className="glass-card p-6 sm:p-8 text-center hover:bg-[var(--background-secondary)] transition-colors sm:col-span-2 lg:col-span-1">
      ...
      <section id="faq" className="py-16 sm:py-24 bg-[var(--background-secondary)]/30 border-y border-[var(--border-color)]">
        <div className="container px-4 max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 sm:mb-12 text-center">Yang Sering Ditanya</h2>
          ...
          <div className="space-y-4 sm:space-y-6">
            {[
              ...
              <div key={i} className="glass-card p-5 sm:p-6 rounded-2xl">
      ...
      <section className="py-16 sm:py-24 relative overflow-hidden">
        ...
        <div className="container px-4 max-w-5xl mx-auto">
          <div className="glass-card p-8 sm:p-12 text-center border-[var(--primary)]/30 relative overflow-hidden">
            {/* Decorative background glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] bg-[var(--primary)]/10 rounded-full blur-[100px] -z-10" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              <Link href="/register" className="btn-primary text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 shadow-xl shadow-blue-500/20 hover:shadow-blue-500/40 transition-all flex items-center gap-3 w-full sm:w-auto justify-center">
                Daftar Sekarang
